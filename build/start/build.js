...
Beast.decl({
    ...
    Main__circle: {
        expand: function () {
            this.domAttr('data-3200-start', 'background-color: rgba(255,255,255,1);' )
            this.domAttr('data-3350-start', 'background-color: rgba(0,0,0,1);' )
        }
    },
...
$(document).ready(function(){
    ...
    //var symbolLogo = $(".Symbol__logo"); 
    //mainContent.css("margin-top", symbolLogo.outerHeight()); 
});
...
Beast.decl({
    Symbol: {
        ...
        expand: function () {
            ...
            if (this.mod('FadeOut')) {
                this.append(Beast.node("logo",{__context:this,"FadeOut":true}))
            }

            if (this.mod('FadeIn')) {
                this.append(Beast.node("logo",{__context:this,"Fadein":true}))
            }
    ...
    Symbol__logo: {
        expand: function () {
            ...
            if (this.mod('FadeOut')) {
                this.domAttr('data-start', 'transform: scale(1); opacity:1; background-color: rgba(255,255,255,1);' )
                this.domAttr('data-300-start', 'transform: scale(0.8); opacity:0.0; background-color: rgba(255,255,255,1);' )
            }

            if (this.mod('FadeIn')) {
                this.domAttr('data-4000-start', 'transform: scale(1.2); opacity:0;' )
                this.domAttr('data-4721-start', 'transform: scale(1); opacity:1;' )  
            }
